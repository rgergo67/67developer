<x-frontend-layout>
    <div class="bg-white">
        <div class="relative overflow-hidden">
            <main>
                <div class="bg-linear-to-r from-black via-retropurple-dark to-retropurple-light bg-linear-to-br ">
                    <x-header />
                                ...
                                <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                                    <div class="lg:py-24">
                                        <a href="/#referencia" class="inline-flex items-center text-white bg-black rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200">
                                            <span class="px-3 py-0.5 text-white text-xs font-semibold leading-5 uppercase tracking-wide bg-linear-to-r from-teal-500 to-cyan-600 rounded-full">{{ __('Referencia') }}</span>
                                        ...
                                        <h1 class="mt-6 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-5xl xl:leading-[1.2]">
                                            ...
                                            <span class="pb-3 block bg-clip-text text-transparent bg-linear-to-r from-teal-200 to-cyan-400 sm:pb-5">{{ __('weboldalakat készítek') }}</span>
                                        </h1>
                            ...
                            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                                <div class="pt-6">
                                    <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                                        <div class="-mt-6">
                                            <div>
                      <span class="inline-flex items-center justify-center p-3 bg-linear-to-r from-teal-500 to-cyan-600 rounded-md shadow-lg">
                ...
                <div class="bg-linear-to-l from-retropurple-light via-retropurple-dark to-black bg-linear-to-bl">
                    <div class="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
                        <div class="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
                            <div class="space-y-5 sm:space-y-4">
                                <h2 id="referencia" class="inline-flex bg-clip-text text-transparent bg-linear-to-r from-retroyellow to-retroyellow-dark text-3xl font-extrabold tracking-tight sm:text-4xl">{{ __('Referencia') }}</h2>
                        ...
                        <div class="lg:grid lg:grid-cols-2 lg:gap-8">
                            ...
                            <div class="flow-root self-center mt-8 lg:mt-0">
                                <div class="-mt-4 -ml-8 flex flex-wrap justify-around lg:-ml-4">
                                    <div class="mt-4 ml-8 flex grow shrink-0 lg:justify-center lg:grow-0 lg:ml-4">
                                        <img class="h-12" src="{{ asset('images/laravel-logo.svg') }}" alt="Laravel">
                                    </div>
                                    <div class="mt-4 ml-8 flex grow shrink-0 lg:justify-center items-center lg:grow-0 lg:ml-4">
                ...
                <!-- CTA Section -->
                <div class="relative bg-linear-to-br from-black to-retropurple-dark">
                    ...
                    <div class="relative mx-auto max-w-md px-4 py-12 sm:max-w-7xl sm:px-6 sm:py-20 md:py-28 lg:px-8 lg:py-32">
                        <div class="md:ml-auto md:w-1/2 md:pl-10">
                            ...
                            <p class="inline-flex mt-2 bg-clip-text text-transparent bg-linear-to-r from-retroyellow to-retroyellow-dark text-3xl font-extrabold tracking-tight sm:text-4xl">
                            ...
                            <div class="mt-8">
                                <div class="inline-flex rounded-md shadow-sm">
                                    <a href="mailto:rgergo67@gmail.com" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-linear-to-br from-retroyellow to-retroyellow-dark hover:bg-gray-50">
                                        rgergo67@gmail.com
                                    </a>
                                </div>
                            </div>
