<header class="relative" x-data="{ open: false }">
                ...
                <div class="flex items-center flex-1">
                    <div class="flex items-center justify-between w-full md:w-auto">
                        ...
                        <div class="-mr-2 flex items-center md:hidden">
                            <button type="button" class="bg-gray-900 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:bg-gray-800 focus:outline-hidden focus:ring-2 focus-ring-inset focus:ring-white" aria-expanded="false" :aria-expanded="open.toString()" @click="open=true">
                    ...
                    <div class="hidden space-x-8 md:flex md:ml-10">
                        ...
                        <a href="/blog" class="text-base font-medium text-white hover:text-gray-300">{{ __('Blog') }}</a>
    ...
    <div x-show="open" x-transition:enter="duration-150 ease-out" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="duration-100 ease-in" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" class="absolute top-0 inset-x-0 p-2 transition transform origin-top md:hidden" x-ref="panel" @click.away="open = false" style="display: none;">
        <div class="rounded-lg shadow-md bg-linear-to-br from-retrodark to-retropurple-dark ring-1 ring-black ring-opacity-5 overflow-hidden">
            <div class="px-5 pt-4 flex items-center justify-between">
                <div>
                    <img class="h-8 w-auto" src="{{ asset('images/67developer-logo.svg') }}" alt="{{ __('67developer programozás') }}">
                </div>
                <div class="-mr-2">
                    <button type="button" class="bg-linear-to-b from-retropurple-light to-retroyellow rounded-md p-2 inline-flex items-center justify-center text-retrodark hover:bg-gray-100 focus:outline-hidden focus:ring-2 focus:ring-inset focus:ring-cyan-600" @click="open = false">
            ...
            <div class="pt-5 pb-6">
                <div class="px-5 space-y-4 bg-linear-to-r from-retroyellow to-retropink bg-clip-text">
