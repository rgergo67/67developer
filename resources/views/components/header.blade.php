            ...
            <div class="flex items-center flex-1 justify-between">
                ...
                <div class="hidden space-x-4 md:flex">
                    ...
                    @if (Lang::getLocale() == 'hu')
                        <a href="{{ route('langroute', 'en') }}" class="font-medium text-base text-white hover:text-gray-300">EN</a>
                    @else
                        <a href="{{ route('langroute', 'hu') }}" class="font-medium text-base text-white hover:text-gray-300">HU</a>
                    @endif
                </div>
            </div>
        </nav>
