        ...
        <form action="{{ route('tools.text-compare') }}#result" method="post">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-2 px-4">
                <div>
                    ...
                    <div class="mt-1">
                        <textarea rows="10" name="text1" id="text1" class="shadow-xs focus:ring-retrodark focus:border-retrodark block w-full sm:text-sm border-gray-300 rounded-md"></textarea>
                    </div>
                </div>
                <div>
                    <label for="text2" class="block text-sm font-medium text-gray-700">{{ __('Ezzel a szöveggel') }}</label>
                    <div class="mt-1">
                        <textarea rows="10" name="text2" id="text2" class="shadow-xs focus:ring-retrodark focus:border-retrodark block w-full sm:text-sm border-gray-300 rounded-md"></textarea>
                    </div>
                </div>
            </div>
            <div class="flex justify-center mt-4">
                <button type="submit" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium shadow-sm rounded-md text-gray-900 bg-linear-to-br from-retroyellow to-retroyellow-dark hover:bg-gray-50">
                    {{ __('Összehasnolítás') }}
                </button>
            </div>
        </form>
